...
namespace MarcNet
{
    public class subFieldsList
    {
        private DupHashlist _myList = new DupHashlist();
        public subFieldsList()
        {

        }

        public void replaceSubField(string subFieldCode, string subField)
        {
            _myList.Replace(subFieldCode, subField);
        }

        public void addSubField(string subFieldCode, string subField)
        {
            _myList.Add(subFieldCode, subField);
        }

        public void removeSubField(string subFieldCode)
        {
            _myList.Remove(subFieldCode);
        }

        public void removeSubField(string subFieldCode, string subField)
        {
